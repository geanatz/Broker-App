...
class SidebarService {
  ...
  List<ButtonConfig> get areaButtons => [
    const ButtonConfig(
      id: 'home',
      title: 'Acasa',
      iconPath: 'assets/home_outlined.svg',
    ...
    const ButtonConfig(
      id: 'form',
      title: 'Formular',
      iconPath: 'assets/form_outlined.svg',
      actionType: ActionType.navigateToArea,
    ...
    const ButtonConfig(
      id: 'calendar',
      title: 'Calendar',
      iconPath: 'assets/calendar_outlined.svg',
      actionType: ActionType.navigateToArea,
  ...
  List<ButtonConfig> get paneButtons => [
    const ButtonConfig(
      id: 'clients',
      title: 'Clienti',
      iconPath: 'assets/clients_outlined.svg',
    ...
    const ButtonConfig(
      id: 'calculator',
      title: 'Calculator',
      iconPath: 'assets/calculator_outlined.svg',
      actionType: ActionType.openPane,
    ...
    const ButtonConfig(
      ...
      iconPath: 'assets/recommend_outlined.svg',
      actionType: ActionType.openPane,
  ...
  static final List<SidebarButtonConfig> sidebarButtons = [
    ...
    const SidebarButtonConfig(
      id: 'form_calls',
      title: 'Clienti',
      iconPath: 'assets/phone_outlined.svg',
