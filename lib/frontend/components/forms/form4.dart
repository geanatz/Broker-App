...
// lib/frontend/common/components/forms/form4.dart
...
/// - Second row: 5 input fields (for credit forms with fixed rate support)
class Form4 extends StatefulWidget {
  ...
  // Second row - input fields (5 fields)
  ...
  /// Title for the fourth input field in second row (Tip rata)
  ...
  /// Title for the fifth input field in second row (Rata fixa)
  final String titleR2F5;
  
  /// Text controller for the fifth input field in second row
  final TextEditingController? controllerR2F5;
  
  /// Hint text for the fifth input field in second row
  final String? hintTextR2F5;
  
  /// Keyboard type for the fifth input field in second row
  final TextInputType? keyboardTypeR2F5;
  
  /// Optional suffix text for the fifth input field (Rata fixa)
  final String? suffixTextR2F5;
  
  /// Optional suffix text color for the fifth input field (Rata fixa)
  final Color? suffixTextColorR2F5;
  ...
  const Form4({
    ...
    this.titleR2F5 = 'Rata fixa',
    this.controllerR2F5,
    this.hintTextR2F5 = '0',
    this.keyboardTypeR2F5 = TextInputType.number,
    this.suffixTextR2F5,
    this.suffixTextColorR2F5,
    this.containerColor,
    this.borderRadius,
    this.padding,
    this.rowSpacing,
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: InputField1(
                        title: widget.titleR2F5,
                        controller: widget.controllerR2F5,
                        hintText: widget.hintTextR2F5,
                        keyboardType: widget.keyboardTypeR2F5,
                        suffixText: widget.suffixTextR2F5,
                        suffixTextColor: widget.suffixTextColorR2F5,
                        enableCommaFormatting: false,
                        enableKTransformation: false,
                      ),
                    ),
