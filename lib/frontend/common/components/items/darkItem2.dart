    ...
    Widget content = Container(
      ...
      child: Row(
        ...
        children: [
          Expanded(
            child: Container(
              // height: 48, // This fixed height within a 64 parent with vertical padding causes the centering
              // clipBehavior: Clip.antiAlias, // Not needed if no clipping content
              // decoration: BoxDecoration(), // Not needed if no decoration
              child: Column(
